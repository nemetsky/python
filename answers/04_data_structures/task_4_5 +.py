...
=== Мое решение (тоже самое впринципе) ===

vlans_1 = command1.split()[-1]
vlans_2 = command2.split()[-1]

list_1 = vlans_1.split(',')
list_2 = vlans_2.split(',')

set_1 = set(list_1)
set_2 = set(list_2)

result = list(sorted(set_1.intersection(set_2)))		# list можно не указывать, sorted возвращает список
print(result)
