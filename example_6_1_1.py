...
# ВАРИАНТ 3
# 
# С циклом while еще один вариант более красивый (прерывания с помощью флага-переменной)
# 
...
# ВАРИАНТ 4
# 
# С оператором break, (без применения флага-переменной позволяет)
# 
...
#     else:
#         print(f"Пароль для {username} прошел все проверки")
#         break                                                 ##  если вместо break указать continue то будет бесконечный цикл, когда введем необходимый пароль
#     password = input("Введите пароль еще раз: ")              # повторный запрос пароля теперь переносим из условий  


# ВАРИАНТ 5
# 
# Тотже вариант 3 только с оператором continue и запросом пароля (в случае если неправильный) только 1 раз после условий, а не в каждом условии
# 
